      ...
      <section className="login-content">
         <div className="row m-0 align-items-center bg-white vh-100">            
                        ...
                        <div className="card-body">
                           ...
                           <form>
                              <div className="row">
                                 ...
                                 <div className="col-lg-12 d-flex justify-content-between">
                                    <div className="form-check mb-3">
                                       ...
                                       <label className="form-check-label" htmlFor="customCheck1">eingeloggt bleiben</label>
                                    </div>
                                    <a href="recoverpw.html">Passwort vergessen?</a>
                                 </div>
                              </div>
                              ...
                              <p className="mt-3 text-center">
                                 Noch keinen Account? <a href="sign-up.html" className="text-underline">Jetzt registrieren.</a>
                              </p>
                           </form>
                        </div>
                     </div>
            ...
            <div className="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="https://www.themoviedb.org/t/p/original/ndZy0eefZb7nX0XRMGLIEDdBZfI.jpg" className="img-fluid gradient-main animated-scaleX" alt="images" />
            </div>
         </div>
      </section>
      </div>
